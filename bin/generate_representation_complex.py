...
# This script:
# 1) Represents each entity using ComplEx embeddings
# 2) Saves to embeddings matrix
# Note: since we are using the ComplEx model as our baseline model, the metrics for this training are the baseline results (hence exported to csv)
...
def main(argv):
    ...
    np.savetxt(embeddings_path, embeddings, fmt='%d')
